...
# Date: 2017-06-14 17:52:45
# Generator: MySQL-Front 6.0  (Build 2.20)


#
# Structure for table "job_cuts"
#

DROP TABLE IF EXISTS `job_cuts`;
CREATE TABLE `job_cuts` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `job_rule_id` int(11) NOT NULL DEFAULT '0',
  `notes` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `job_rule_id` (`job_rule_id`),
  CONSTRAINT `job_cuts_ibfk_1` FOREIGN KEY (`job_rule_id`) REFERENCES `job_rules` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "job_cuts"
#

INSERT INTO `job_cuts` VALUES (1,25,'Наш первый CUT!');

#
# Structure for table "job_cut_xpath"
#

DROP TABLE IF EXISTS `job_cut_xpath`;
CREATE TABLE `job_cut_xpath` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `job_cut_id` int(11) NOT NULL DEFAULT '0',
  `xpath` text NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `job_cut_id` (`job_cut_id`),
  CONSTRAINT `job_cut_xpath_ibfk_1` FOREIGN KEY (`job_cut_id`) REFERENCES `job_cuts` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "job_cut_xpath"
#
...
INSERT INTO `job_rules` VALUES (14,2,'Next Page Link',0,0,65280),(19,3,'Article Link',4,0,15780518),(23,6,'',0,0,15780518),(25,7,'content',0,0,15780518);
